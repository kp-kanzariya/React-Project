...
import i20 from '../../imgs/i20.jpg'
import i9 from '../../imgs/i9.jpg'
import i15 from '../../imgs/i15.jpg'
import i10 from '../../imgs/i10.jpg'
import i14 from '../../imgs/i14.jpeg'
              ...
              <div className="col-3">
                <div className="row">
                  <div className="col-12 mb-3">
                    <img src={i20} class="img-fluid imh"  alt="Image 1" />
                  </div>
                  <div className="col-12">
                    <img src={i9} class="img-fluid imh"  alt="Image 2" />
                  </div>
                </div>
              </div>
              <div className="col-9 mb-2 ">
                <img src={i15} class="img-fluid" alt="Image 3" />
              </div>
            </div>
            <div className="row">
              <div className="col-2">
                <img src={i9} class="img-fluid" alt="Image 2" />
              </div>
              <div className="col-2">
                <img src={i2} class="img-fluid" alt="Image 2" />
              </div>
              <div className="col-2">
                <img src={i14} class="img-fluid" alt="Image 2" />
              </div>
              <div className="col-2">
                <img src={i15} class="img-fluid" alt="Image 2" />
              </div>
              <div className="col-2">
                <img src={i20} class="img-fluid" alt="Image 2" />
              </div>
              <div className="col-2">
                <img src={i10} class="img-fluid" alt="Image 2" />
              </div>
            </div>
          </div>
